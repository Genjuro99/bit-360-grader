...
check('Non-destructive QA-test application ID suffix', appGradle.includes("applicationIdSuffix '.qatest'"));
...
check('Test version code', appGradle.includes('versionCode 104'));
check('Test version name', appGradle.includes("versionName '1.0.4-test'"));
check('QA-test app label', strings.includes('BIT360 Grader QA Test'));
